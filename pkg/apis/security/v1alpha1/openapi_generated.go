...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/giantswarm/apiextensions/v3/pkg/apis/security/v1alpha1.Organization":     schema_pkg_apis_security_v1alpha1_Organization(ref),
		"github.com/giantswarm/apiextensions/v3/pkg/apis/security/v1alpha1.OrganizationList": schema_pkg_apis_security_v1alpha1_OrganizationList(ref),
		"github.com/giantswarm/apiextensions/v3/pkg/apis/security/v1alpha1.OrganizationSpec": schema_pkg_apis_security_v1alpha1_OrganizationSpec(ref),
...
func schema_pkg_apis_security_v1alpha1_Organization(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/giantswarm/apiextensions/v3/pkg/apis/security/v1alpha1.OrganizationSpec"),
						},
					},
				},
		...
		Dependencies: []string{
			"github.com/giantswarm/apiextensions/v3/pkg/apis/security/v1alpha1.OrganizationSpec", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}

func schema_pkg_apis_security_v1alpha1_OrganizationList(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				Type: []string{"object"},
					...
					"items": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/giantswarm/apiextensions/v3/pkg/apis/security/v1alpha1.Organization"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/giantswarm/apiextensions/v3/pkg/apis/security/v1alpha1.Organization", "k8s.io/apimachinery/pkg/apis/meta/v1.ListMeta"},
	}
}
